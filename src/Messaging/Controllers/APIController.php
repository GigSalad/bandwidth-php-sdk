...
class APIController extends BaseController
{
    ...
    protected function buildApiResponse(
        ...
        if ($mapToClass) {
            $responseBody = $this->getJsonMapper()->mapClassArray(
                $responseBody,
                $mapToClass,
            );
        }
        ...
        return new ApiResponse(
            $response->code,
            $response->headers,
            !$nullResponseBody ? $responseBody : null,
        );
    }
    ...
    public function listMedia(
        ...
        $response = $this->makeRequest(HttpMethod::GET, $url, $headers);
    ...
    public function getMedia(string $accountId, string $mediaId): ApiResponse
    {
        ...
        $response = $this->makeRequest(HttpMethod::GET, $url);
    ...
    public function uploadMedia(
        ...
        $response = $this->makeRequest(HttpMethod::PUT, $url, $headers, $body);
    ...
    public function deleteMedia(string $accountId, string $mediaId): ApiResponse
    {
        ...
        $response = $this->makeRequest(HttpMethod::DELETE, $url);
    ...
    public function createMessage(
        ...
        [$url, $mapToClass] = match ($body::class) {
        ...
        $response = $this->makeRequest(HttpMethod::GET, $url, $headers, $body);

        return $this->buildApiResponse($response, $mapToClass);
    }
